...
public class RabbitMQConfig {
     ...
     * and it specifies the routing key that should be used when sending messages to the queue.
     *
     ...
     *
     * @param connectionFactory the ConnectionFactory to use for establishing connections
     * @param jsonMessageConverter the Jackson2JsonMessageConverter to use for converting messages to and from JSON
