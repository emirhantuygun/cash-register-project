...
//
//        // Mocking ServerHttpRequest for the test cases
...
//        // Mocking behavior for routeValidator
//        ServerHttpRequest request1 = MockServerHttpRequest.get("/auth").build();
//        ServerHttpRequest request2 = MockServerHttpRequest.get("/product").build();
//        when(routeValidator.isOpenEndpoint.test(request1)).thenReturn(false);
//        when(routeValidator.isRoleBasedAuthorizationNeeded.test(request2)).thenReturn(true);
//
//        // Mocking behavior for JwtUtils
