...
public class ChartService {
    ...
    private final GeminiApiExample geminiApiExample;
    ...
    public byte[] generateChart(Map<String, Integer> productQuantityMap) throws IOException, DocumentException, FontFormatException {

        BaseFont baseFontLight = BaseFont.createFont("fonts/rubik-light.ttf", BaseFont.IDENTITY_H, BaseFont.EMBEDDED);
        BaseFont baseFontRegular = BaseFont.createFont("fonts/rubik-regular.ttf", BaseFont.IDENTITY_H, BaseFont.EMBEDDED);
        ...
        document.add(new Paragraph("\n"));
        String saleFigures = convertSalesDataToText(salesData);
        String saleAnalysis = geminiApiExample.prompt(saleFigures);
...
//            Paragraph aiText = new Paragraph(saleAnalysis, lightSmall);
//            aiText.setFirstLineIndent(40);
//            document.add(aiText);
